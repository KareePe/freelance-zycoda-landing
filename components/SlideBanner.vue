        ...
        >
          ...
          >
            <div class="lg:text-left text-center">
              <div
                v-html="locale === 'en' ? slide.topic_en : slide.topic_th"
...
let slideData = [
  {
    topic_en: 'ZYCODA Leading the Way in<br>"AI-Driven Maintenance"',
    topic_th: 'ZYCODA Leading the Way in<br>"AI-Driven Maintenance"',
    desc_en:
